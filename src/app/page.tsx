...
import { useTheme } from "next-themes";
import { motion } from "framer-motion";
import { Heart, Users, Briefcase, Star, Shield, Coffee, Github, Twitter, Sparkles, Zap, Lock, Clock, Gift, Upload, Linkedin } from "lucide-react";
      ...
      <section className="py-16 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <Link href="/readings">
              <Button size="lg" variant="secondary" className="rounded-2xl font-medium text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <Link href="/about" className="block text-gray-600 dark:text-gray-400 hover:text-teal-600 transition-colors">
                  How It Works
                </Link>
                <Link href="/privacy" className="block text-gray-600 dark:text-gray-400 hover:text-teal-600 transition-colors">
                  Privacy Policy
                </Link>
                <Link href="/terms" className="block text-gray-600 dark:text-gray-400 hover:text-teal-600 transition-colors">
                  Terms of Service
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/Adamya-Gupta/" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 transition-colors">
                  {/* <Github className="w-5 h-5" /> */}
                  <IconBrandGithub className="w-5 h-5"/>
                </a>
                <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 transition-colors">
