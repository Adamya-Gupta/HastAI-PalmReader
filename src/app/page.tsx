    ...
    <main
      className={`min-h-screen transition-colors duration-500 ${
        theme === "dark"
          ...
          : "bg-gradient-to-b from-green-100 via-white to-blue-100 text-gray-900"
      }`}
    >
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between px-8 py-20 max-w-7xl mx-auto">
        ...
        <div className="flex-1 text-center lg:text-left mb-12 lg:mb-0 space-y-6">
          ...
          >
            Decode Your <span className="text-green-700">Future</span> <br />
            from Your <span className="text-yellow-400">Palm</span>
          </motion.h1>
